...
If you are developing a highly specialized, multi-step onboarding wizard and require absolute control over every transition and input field, we recommend bypassing this pre-built component.
