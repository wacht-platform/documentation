...
The `AuthLayer` provides JWT token validation middleware for Axum web applications. It validates Bearer tokens, extracts user context, and makes it available to your route handlers.
