...
The backend SDK create request accepts core fields like:
...
### Option A: Backend SDK (`@wacht/backend`)
...
1. [Node SDK Introduction](/node-sdk/introduction)
2. [Backend API Notifications Reference](/backend-api/notifications)
