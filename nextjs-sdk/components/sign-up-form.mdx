...
Place the component on a dedicated public registration route (e.g., `/sign-up/page.tsx`). It will automatically render input fields based on the required attributes configured in your Wacht Dashboard. For example, if you require a user to provide a "First Name" and "Last Name", those fields are instantly rendered with full validation.
