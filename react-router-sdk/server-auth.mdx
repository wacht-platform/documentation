---
title: 'Server Auth'
description: 'Reference for @wacht/react-router/server request authentication helpers.'
---
...
Use this when the request can rotate or exchange session state.
...
- [react-router/lib/server/middleware.ts](/Users/snipextt/code/wacht/react-sdk/react-router/lib/server/middleware.ts)
