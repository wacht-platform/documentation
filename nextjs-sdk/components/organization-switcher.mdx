...
```tsx
import { OrganizationSwitcher, UserButton } from "@wacht/nextjs";
...
3. **Reactivity**: Any React components or data-fetching libraries (like SWR or Apollo) that hook into Wacht's session state will automatically re-render or re-validate. This guarantees that your application never accidentally bleeds data between tenants.
