...
<ResponseField name="acceptInvitation" type="(token: string) => Promise<AcceptInvitationResponse>">
  <Expandable title="Accept an invitation with the given token">
    <ParamField path="token" type="string" required>
      The invitation token
    </ParamField>
    <ResponseField name="returns" type="Promise<AcceptInvitationResponse>">
      The invitation response data
    </ResponseField>
  </Expandable>
</ResponseField>

<ResponseField name="invitationData" type="AcceptInvitationResponse | null">
...
```tsx
import { useInvitation } from "@wacht/tanstack-router";
