...
The **TanStack Router SDK** (`@wacht/tanstack-router`) provides comprehensive authentication and user management for TanStack Router applications. It includes pre-built components, hooks for authentication flows, and utilities for managing users, organizations, and workspaces.
