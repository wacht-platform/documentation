...
<ResponseField name="client" type="(url: string, options?: RequestInit) => Promise<Response>">
  <Expandable title="The HTTP client function for making authenticated requests">
    ...
    <ResponseField name="returns" type="Promise<Response>">
...
```tsx
import { useClient } from "@wacht/react-router";
